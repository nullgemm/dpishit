...
folder_library="\$folder_dpishit/lib/dpishit/win"
...
{ \
echo "# copy headers"; \
echo "build \$folder_include/dpishit_win.h: \$"; \
echo "cp src/include/dpishit_win.h"; \
echo ""; \
} >> "$output/$ninja_file"

{ \
echo "build headers: phony \$"; \
echo "\$folder_include/dpishit_win.h"; \
echo ""; \
} >> "$output/$ninja_file"
