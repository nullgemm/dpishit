...
obj+=("$folder_objects/dpishit_x11.o")
obj+=("$folder_objects/dpishit_elf.o")

# parse soname
soname="$folder_library/x11/dpishit_x11.so"

# extract objects from static archives
ar --output "$folder_objects" -x "$folder_library/x11/dpishit_x11.a"
ar --output "$folder_objects" -x "$folder_library/dpishit_elf.a"
