...
folder_library="\$folder_dpishit/lib/dpishit/x11"
...
{ \
echo "# copy headers"; \
echo "build \$folder_include/dpishit_x11.h: \$"; \
echo "cp src/include/dpishit_x11.h"; \
echo ""; \
} >> "$output/$ninja_file"

{ \
echo "build headers: phony \$"; \
echo "\$folder_include/dpishit_x11.h"; \
echo ""; \
} >> "$output/$ninja_file"
